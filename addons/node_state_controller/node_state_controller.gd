...
## Holds a reference to the intial state in which this node enters first
@export var initial_node_state : NodeState 

## Holds a reference to all the states under this node
var node_states : Dictionary = {}
## Holds a reference to the currently active state
var current_node_state : NodeState
## Holds a reference to the name of the currently active state
...
## used to automatically change the current state to the input state if it exists
